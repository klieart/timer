...
class TimersControllerTest < ActionController::TestCase
  ...
  test "should create timer" do
    assert_difference('Timer.count') do
      post :create, timer: { name: @timer.name, timer: @timer.timer, user2timer_id: @timer.user2timer_id, user2timer_type: @timer.user2timer_type }
    end
  ...
  test "should update timer" do
    patch :update, id: @timer, timer: { name: @timer.name, timer: @timer.timer, user2timer_id: @timer.user2timer_id, user2timer_type: @timer.user2timer_type }
    assert_redirected_to timer_path(assigns(:timer))
  end
